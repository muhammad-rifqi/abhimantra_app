...
CREATE TABLE public.points (
    ...
    wilayah character varying(100) DEFAULT 'null'::character varying,
...
COPY public.points (id, name, wilayah, coordinate, created_at, updated_at) FROM stdin;
1	kedai Kopi ABG	Blok M Plaza	-6.24399625034816, 106.79764040000153	08:05:42+00	08:05:42+00
\.
...
COPY public.user_login (id, email, password, access_level, token) FROM stdin;
1	admin@gmail.com	123456789	1	Abc12345678ssdf
\.
